package net.mineles.commands.jda.misc;

import com.google.common.collect.ImmutableList;
import net.mineles.commands.jda.annotation.JDACommandCompletion;
import net.mineles.commands.jda.annotation.JDACommandCompletions;
